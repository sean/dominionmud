...
*                                                                         *
*  File:  RANDOM.C                                     Based on CircleMUD *
*  Usage: Functions for random number generator                           *
*  Programmer(s): Original code by Sean Mountcastle (Glasgian)            *
*                 Based on code by Jeremy Elson and Loki of SillyMUD      *
\*********************************************************************** */
