...
/*. Exported globals .*/
#ifdef __CREATION_C__
static char *nrm, *grn, *cyn, *yel;
static struct olc_save_info *olc_save_list = NULL;
#endif
...
#define OLC_GUILD(d)    ((d)->olc->guild)       /*. Guild Struct        .*/
#define OLC_HELP(d)     ((d)->olc->help)        /*. Help Struct        .*/
...
/*. Help Edit Modes .*/
#define HEDIT_CONFIRM_SAVE              1
#define HEDIT_MAIN_MENU                 2

/*. OLC Default Modes .*/
#define OLC_MAIN_MENU                   0
#define OLC_ZEDIT_SELECT                1
#define OLC_REDIT_SELECT                2
#define OLC_OEDIT_SELECT                3
#define OLC_MEDIT_SELECT                4
#define OLC_SEDIT_SELECT                5
#define OLC_GEDIT_SELECT                6
#define OLC_RELEDIT_SELECT              7
#define OLC_RACEDIT_SELECT              8
#define OLC_SKEDIT_SELECT               9
#define OLC_HEDIT_SELECT                10
